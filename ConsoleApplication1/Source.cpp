...
void main()
{
	...
	do {
		...
		if (N == 1)
		{
			/*1.1.	Создайте одномерный массив целого типа заданного размера M. 
		...
		{
			/*2.	2.	Массив предназначен для хранения значений весов двадцати человек. 
		...
		else if (N == 5)
		{
			...
			//разве это последний элемент!? 
			for (int i = 0; i < 20; i++)
			{
				f[i] *= f[15];//Мне кажеться поседний элемент 20
